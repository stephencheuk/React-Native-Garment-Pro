...
xcopy /y build\outputs\apk\app-release-unsigned.apk build\outputs\apk\app-release.apk
...
"C:\Program Files\Java\jdk1.8.0_66\bin\jarsigner.exe" -verbose -keystore my-release-key.keystore build\outputs\apk\app-release.apk my-key-alias
